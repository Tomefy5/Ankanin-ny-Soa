...
export default function Programs() {
  return (
    <div className="bg-gray-200 pt-16 min-h-[100vh] flex flex-col text-center items-center justify-start overflow-hidden">
      ...
      <div className="mt-8 lg:mt-16 flex flex-wrap items-center justify-center px-4">
        ...
        <div className="relative bg-gray-300 px-6 py-4 md:mx-6 smd:mt-0 w-[300px] h-[396px] xsm:w-[370px] xsm:h-[466px] md:w-[420px] md:h-[516px] rounded-tl-[37%] rounded-tr-[40%] rounded-bl-[35%] rounded-br-[50%]">
        ...
        <div className="relative bg-gray-300 px-6 py-4 mt-12 md:mx-6 smd:mt-0 w-[300px] h-[396px] xsm:w-[370px] xsm:h-[466px] md:w-[420px] md:h-[516px] rounded-tl-[37%] rounded-tr-[40%] rounded-bl-[35%] rounded-br-[50%]">
          <div className="bg-gray-100 overflow-hidden mx-auto w-[95%] h-1/2 rounded-tl-[40%] rounded-tr-[50%] rounded-bl-[25%] rounded-br-[40%]">
            <img
              className="object-cover h-full"
              src={imageProg1}
