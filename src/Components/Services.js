  ...
  return (
    <div className="h-auto py-16 pt-5 bg-gray-100">
      ...
      <div className="flex flex-wrap mt-10 justify-center xl:h-[40vh]">
        <a
          href="#service"
          className="xl:flex-link-service py-4 mx-0 bg-gra-300 w-[90%] max-w-[306px] lg:px-10 flex flex-col text-center items-center justify-center"
        >
          <div className="w-[80%] mx-auto flex items-center justify-center">
            <img src={imageService} alt="blob" />
          </div>
          <h3 className="font-medium text-xl mt-5">Choose A Service</h3>
