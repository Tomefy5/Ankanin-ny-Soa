  ...
  return (
    <div className="mt-16 max-w-3xl h-auto lg:max-w-none mx-auto w-auto  grid grid-cols-1 lg:grid-cols-2 lg:min-w-5xl lg:w-[1040px] xl:w-[1300px]">
      <div className="flex flex-col items-center p-4 md:items-start md:px-8 lg:justify-center">
        <h2 className="mb-4 lg:mb-8">Kindergarten & Baby Care <span className="ml-1">✨</span></h2>
        <h1 className="font-extrabold text-4xl text-center mb-4 lg:mb-8 md:text-6xl xl:text-7xl md:text-start">
          Kid's Promising Tomorrow Ahead
        </h1>
        ...
        <a
          href="#apply"
          className="flex items-center justify-between ring-1 ring-gray-800 rounded-xl mt-5 md:mt-10 lg:mt-12 py-3 md:py-4 px-5 md:px-7 "
        >
