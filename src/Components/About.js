...
import iconPhone from "../Assets/icons/phone-svgrepo-com2.svg"

export default function About() {
  return (
    <div className="h-auto min-h-[100vh] bg-yellow-100 flex lg:items-center lg:justify-center">
      <div className="w-full container mx-auto md:mx-6 lg:mx-0 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="w-full p-5">
          <h2 className="font-medium mb-4 text-xl text-rose-500">About Us</h2>
          <h1 className="font-bold text-3xl md:text-4xl xl:text-5xl text-yellow-500">Top Choice For Children</h1>
          <p className="mt-5">
          ...
          <div className=" mt-10 w-2/3 xl:w-3/4 lg:w-11/12 grid gap-5 grid-cols-1 md:grid-cols-2">
            <div className="flex items-center justify-start rounded-2xl w-[215px] px-3 py-3 shadow-lg">
          ...
          <div className="flex items-center justify-between md:justify-start flex-wrap w-[347px] md:w-full mt-5 md:mt-10 lg:mt-12">
            ...
            <div className="ml-0 md:ml-8 flex items-center mt-6 md:mt-0">
              <div className="h-[60px] w-[60px] flex items-center justify-center rounded-[50%] border border-rose-500">
                <div className="bg-rose-500 h-[48px] w-[48px] flex items-center justify-center rounded-[50%]">
                  <img className="h-6" src={iconPhone} alt="icon phone" />
                </div>
              </div>
              <div className="flex flex-col h-full ml-3">
                <span className="font-normal text-sm">Call Us Now</span>
