...
export default function ServiceContainer() {
  return (
    <div className="bg-blue-600 max-w-[368px] min-w-[300px] lg:max-w-none mx-auto md:mx-0 rounded-3xl p-8 h-[432px] xl:h-[492px] text-white shadow-xl flex flex-col justify-between">
